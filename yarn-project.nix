...
let
  ...
  yarnBin = fetchurl {
    url = "https://repo.yarnpkg.com/4.10.3/packages/yarnpkg-cli/bin/yarn.js";
    hash = "sha512-w4yvtce7Jz85JtBOVeHYyd+n2cPqHzakho+gKLnl9yKY8Lf0Aa1euSF0nrAS6xw7t0v3UD3z7kP9YA0UoBgmbw==";
  };
  ...
  cacheDrv = stdenv.mkDerivation {
    ...
    outputHash = "sha512-yBEWDT4vORUehFnzZNR4/FKA+mOqbae5/KEY8pbqL0QrTzQXeiZd4lygTJ2UHbo6tEWUpWskhWKmivObf4LqOA==";
  };

  # Main project derivation.
  project = stdenv.mkDerivation (drvCommon // {
    inherit src;
    name = "github-vscode-theme-monochrome";
